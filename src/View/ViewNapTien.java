...
import Controller.ControllerNapTien;
...
public class ViewNapTien extends JFrame {

	private static final long serialVersionUID = 1L;
	private JPanel contentPane;
	private JTextField textField_SoTien;
	public static ViewNapTien frame;
	 ...
	 */
	public ViewNapTien() {
		ControllerNapTien controllernaptien = new ControllerNapTien(this);
		...
		JLabel lblNewLabel_headerNapTien = new JLabel(" Nạp tiền");
		lblNewLabel_headerNapTien.setForeground(new Color(255, 0, 0));
		lblNewLabel_headerNapTien.setFont(new Font("Times New Roman", Font.BOLD, 43));
		lblNewLabel_headerNapTien.setBounds(132, 3, 173, 67);
		contentPane.add(lblNewLabel_headerNapTien);
		
		JButton btnNewButton_NapTien = new JButton("Nạp tiền");
		btnNewButton_NapTien.setBackground(new Color(0, 255, 0));
		btnNewButton_NapTien.setFont(new Font("Times New Roman", Font.BOLD, 15));
		btnNewButton_NapTien.setBounds(255, 212, 100, 30);
		...
		btnNewButton_Huy.addActionListener(controllernaptien);
